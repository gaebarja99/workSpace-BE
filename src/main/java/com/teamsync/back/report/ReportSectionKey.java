...
/**
 * FR-405 보고서 템플릿 섹션의 종류. COMPLETED/IN_PROGRESS/ISSUES는 WeeklyReportService의
 ...
 * 팀 채팅(하이라이트) 기능 제거에 따라 HIGHLIGHTS 표준 섹션은 더 이상 지원하지 않는다.
 * 이번 세션은 템플릿 관리(CRUD)만 구현하며, 실제 주간보고 작성 화면이 이 템플릿을 읽어 반영하는 연동은
 * 후속 과제다(WeeklyReportService의 실시간 계산 로직은 그대로 유지).
 */
